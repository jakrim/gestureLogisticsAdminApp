...
export default class MultiSwitch extends Component {
  ...
  notStartedSelected = () => {
    ...
    this.props.onStatusChanged('online');
  };
  ...
  offlineSelected = () => {
    ...
    this.props.onStatusChanged('offline');
  };
  ...
  render() {
    return (
      <View style={styles.container}>
        <Button type='online' onPress={this.notStartedSelected} />
        <Button type='noFilter' onPress={this.inProgressSelected} />
        <Button type='offline' onPress={this.offlineSelected} />
        <Animated.View
